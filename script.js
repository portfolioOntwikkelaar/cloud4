...
function init() {
   ...
   clock = new THREE.Clock();
    ...
    light = new THREE.DirectionalLight(0x5F5FF0,0.5); //Change color of smoke here
    ...
    for (p = 0; p < 150; p++) {
        ...
        particle.position.set(Math.random()*500-250,Math.random()*500-250,Math.random()*1000-70);
...
function render() {
    ...
    cubeSineDriver += .01;
    mesh.position.z = 80 + (Math.sin(cubeSineDriver) * 500);
